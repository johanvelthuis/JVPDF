...
$pageCount = $pdf->setSourceFile(__DIR__ . '/template.pdf');
$tplIdx = $pdf->importPage(1);
$pdf->AddPage();
$pdf->useTemplate($tplIdx);

$pdf->setSourceFile(__DIR__ .'/img/logo.pdf');
...
// ---------------------------------------------------------
$pdf->ImageSVG(__DIR__.'/img/logo.svg', 50, 200, 30,30);//??Zie ik nog niet. Maar misschien is de eps niet goed.
